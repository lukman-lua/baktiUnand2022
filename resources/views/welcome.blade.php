  ...
  <div id="test-target" class="uk-height-large uk-background-cover uk-light uk-flex" uk-parallax="bgy: 20">
    <div class="col-sm-12">
      <div class="twelfth-img container-fluid">
        <div uk-parallax="target: #test-target; y: -10,200">
          <img class="tugas-label uk-position-right" src="image/tugas-label.png" alt="">
...
<footer>
  <div class="container text-center" style="margin-top:-100px;">
    <div>
      <a href="https://www.instagram.com/bakti_unand/" style="text-decoration:none;" class="fa-brands fa-instagram"></a>
      <a href="https://www.facebook.com/baktiunand2021" style="text-decoration:none;" class="fa-brands fa-facebook-f"></a>
      <a href="#" style="text-decoration:none;" class="fa-brands fa-twitter"></a>
      <a href="https://www.youtube.com/channel/UCa2DLgH6PmtSWbdoik4XLVQ/featured" style="text-decoration:none;" class="fa-brands fa-youtube"></a>
      <a href="https://www.tiktok.com/@bakti_unand?is_from_webapp=1&sender_device=pc" style="text-decoration:none;" class="fa-brands fa-tiktok"></a>
    </div>
  </div>
</footer>
@endsection